<?php
	...
	//Check entered department code to determine display
		...
		<div class ="col-md-8 col-md-offset-2">
			<div class = "row views">
				...
				<div style="margin-left:100px">
					<?php
						$commandE = 'java -cp .:mysql-connector-java-5.1.40-bin.jar RegistrationDbManager E ' . $depCode;
						$commandE = escapeshellcmd($commandE); //Remove dangerous characters
						system($commandE); ?>
				</div>
				 <br>
