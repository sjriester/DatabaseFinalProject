<?php 
	...
	//Check entered student ID to determine display
			...
			<div class = "row views">
				...
				<div style="margin-left:100px">
					<?php 
						...
						$commandF = 'java -cp .:mysql-connector-java-5.1.40-bin.jar RegistrationDbManager F ' . $stuId;
						$commandF = escapeshellcmd($commandF); //Remove any dangerous characters
						system($commandF);
					?>
				</div>
				 <br>
